...
//	dbg ("real     std0 = %4d          std1 = %4d     std2 = %4d", std_ad0, std_ad1, std_ad2);
	for (is = 0; is < COIN_TYPE_NUM; is++){ //补偿值
		coin_cmp_value[is].compare_max0 = calc_fb_func (0, para_set_value.data.base_std0, std_ad0, pre_value.coin[is].data.max0)+pre_value.coin[is].data.offsetmax0;
		coin_cmp_value[is].compare_max1 = calc_fb_func (0, para_set_value.data.base_std1, std_ad1, pre_value.coin[is].data.max1)+pre_value.coin[is].data.offsetmax1;
		coin_cmp_value[is].compare_max2 = calc_fb_func (1, para_set_value.data.base_std2, std_ad2, pre_value.coin[is].data.max2)+pre_value.coin[is].data.offsetmax2;
		coin_cmp_value[is].compare_min0 = calc_fb_func (1, para_set_value.data.base_std0, std_ad0, pre_value.coin[is].data.min0)+pre_value.coin[is].data.offsetmin0;
		coin_cmp_value[is].compare_min1 = calc_fb_func (2, para_set_value.data.base_std1, std_ad1, pre_value.coin[is].data.min1)+pre_value.coin[is].data.offsetmin1;
		coin_cmp_value[is].compare_min2 = calc_fb_func (2, para_set_value.data.base_std2, std_ad2, pre_value.coin[is].data.min2)+pre_value.coin[is].data.offsetmin2;
/*
