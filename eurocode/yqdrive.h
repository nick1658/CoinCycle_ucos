...
#define OUT9(x) (rGPFDAT = (rGPFDAT & (~(0x01<<6))) |(x<<6))	//EINT6/GPF6
#define OUT8(x) (rGPFDAT = (rGPFDAT & (~(0x01<<5))) |(x<<5))	//EINT5/GPF5
...
#define PAYOUT0(x)		OUT7(x)
#define PAYOUT1(x)		OUT8(!x)
...
#define BELT_MOTOR_STARTRUN() 		 OUT6(0)
#define BELT_MOTOR_STOPRUN()			 OUT6(1)
...
#define HOPPER0_CNT_IN	A0IN2
#define HOPPER1_CNT_IN	A0IN3
#define HOPPER2_CNT_IN	A0IN4
