...
void refresh_data (void)
{
	...
	pc_print("%d$%d;",89, pre_value.coin[sys_env.coin_index].data.std0);
	pc_print("%d$%d;",90, pre_value.coin[sys_env.coin_index].data.std1);
	pc_print("%d$%d;",91, pre_value.coin[sys_env.coin_index].data.std2);
